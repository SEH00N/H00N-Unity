    ...
    public class ConditionalFieldDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else
            {
                ...
                conditionMet = conditionSimStates[conditionKey];
            }
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            bool sourceExists = sourceProperty != null;
            bool conditionMet = sourceExists ? EvaluateCondition(sourceProperty, condAttrib) : true;
            ...
            if (!sourceExists && EditorPrefs.GetBool(editorPrefsKey, false))
