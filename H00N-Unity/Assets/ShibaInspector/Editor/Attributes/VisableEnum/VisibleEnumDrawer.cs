...
//             {
//                 EditorGUI.BeginChangeCheck();
//                 UnityEngine.Object @object = EditorGUI.ObjectField(position3, GUIContent.none, propertyRelative6.objectReferenceValue,
//                     type, true);
//                 if (EditorGUI.EndChangeCheck())
...
//                 if (method == null)
//                 {
//                     method = GetMethod(m_DummyEvent, propertyRelative5.stringValue,
//                         propertyRelative4.objectReferenceValue,
//                         GetMode(propertyRelative2), typeof(Enum));
//                 }
...
//                 {
//                     if (!IsPersistantListenerValid(m_DummyEvent, propertyRelative5.stringValue,
//                     propertyRelative4.objectReferenceValue, GetMode(propertyRelative2), typeof(Enum)))
//                     {
...
//         private static IEnumerable<ValidMethodMap> CalculateMethodMap(UnityEngine.Object target, IReadOnlyList<Type> t,
...
//             GetMethodsForTargetAndMode(target, new[] { typeof(Enum) }, methods, PersistentListenerMode.Int, true);
