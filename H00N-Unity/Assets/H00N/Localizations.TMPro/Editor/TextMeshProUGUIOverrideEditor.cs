...
namespace H00N.Localizations
{
    ...
    public class TextMeshProUGUIOverrideEditor : TMPro.EditorUtilities.TMP_EditorPanelUI
    {
        ...
        {
            var tmpTexts = targets.OfType<TextMeshProUGUI>().ToArray();
        ...
        private void AddLocalizeFontGroupEvent(TextMeshProUGUI tmpText)
        {
